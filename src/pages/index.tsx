  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your business with HR Management Application, a comprehensive solution for all your human resource needs, ensuring efficiency and productivity at its best."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your business with HR Management Application, a comprehensive solution for all your human resource needs, ensuring efficiency and productivity at its best.`}
            </Text>
            <Box
