...
import { useRoqPlatformUserProfiles, useScheduleCount, useJobPostingCount, usePositionCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const positionStat = usePositionCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Positions',
      result: positionStat?.data,
      isLoading: positionStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
